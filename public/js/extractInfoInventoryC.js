...
//exports.getInfo = function(req, res){
    var sql = "SELECT * FROM pharmaceutical, inventory_item WHERE CLEARENCE_LEVEL='C'";
    ...
    stringboi += JSON.stringify({name: result[lasti].NAME, expiration_date: result[lasti].EXPIRATION_DATE, 
        sale_price: result[lasti].SALE_PRICE, description: result[lasti].DESCRIPTION, dosage: result[i].DOSAGE}, null, "\t");
    stringboi += "]";
